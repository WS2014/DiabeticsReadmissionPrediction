...
train = pd.read_csv("../data/combined/complete_cleared_pandas_train_combi_another.csv", dtype={'admission_type_id':np.object, 'discharge_disposition_id':np.object, 'admission_source_id':np.object, 'diag_1':np.object, 'diag_2':np.object, 'diag_3':np.object})

test = pd.read_csv("../data/combined/complete_cleared_pandas_test_combi_another.csv", dtype={'admission_type_id':np.object, 'discharge_disposition_id':np.object, 'admission_source_id':np.object, 'diag_1':np.object, 'diag_2':np.object, 'diag_3':np.object})
...
#rf = RandomForestClassifier(n_estimators=100, max_features=15, n_jobs=4, max_depth=5)
...
out = open('../results/rf_combi_another.txt','w')
