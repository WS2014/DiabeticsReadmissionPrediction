...
out = open('../results/All_plot30_MORE.txt','w')
pp = PdfPages('../results/All_plot30_MORE.pdf')
...
clf4 = OneVsRestClassifier(AdaBoostClassifier(base_estimator=RandomForestClassifier(n_estimators=250, max_features='auto', n_jobs=4, max_depth=5)))
