...
out = open('../results/select_SVM.txt','w')
pp = PdfPages('../results/select_SVM.pdf')
...
#"""
#vectorize
x_cat_all = cat_all.T.to_dict().values()
vectorizer = DV(sparse = False)
vec_x_cat_all = vectorizer.transform(x_cat_all)
#"""
"""
#Factorize
