...
out = open('../results/try3.txt','w')
pp = PdfPages('../results/try3.pdf')
...
clf = OneVsRestClassifier(RandomForestClassifier(n_estimators=100, max_features='auto', n_jobs=4, max_depth=7))
