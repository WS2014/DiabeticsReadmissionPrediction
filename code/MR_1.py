...
all = pd.read_csv("../data/intuition/MR_features_1.csv", dtype={'admission_type_id':np.object, 'discharge_disposition_id':np.object, 'admission_source_id':np.object})

out = open('../results/MR1.txt','w')
pp = PdfPages('../results/MR1.pdf')
